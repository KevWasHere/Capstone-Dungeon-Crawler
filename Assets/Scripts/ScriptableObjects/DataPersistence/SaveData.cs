...
/* this script is not used for the current project
 * the purpose of the script is to save the data and make the scene persistence 
 * it is for futher development
 */
