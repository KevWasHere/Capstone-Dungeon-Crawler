...
{
    /*
     * Class: UItooltiplines 
     * 
     * Description:
     *      it contains basic information of the tooltip that how the ui iteminfo append to 
     *      the tooltip panel on gui.
     *      It could be added a new line or a column so that the tooltip will be varied depended on 
     *      what type of slot that item is at.
     */
	public class UITooltipLines {
		
		public enum LineStyle               // enum of linestyle for 3 type of lines that are title, attribute and description
		{
			Title,
			Attribute,
			Description
         ...
         * Class: Line
         * Description:
         *      define the basic style of line that how it would look like and its style
         * 
         */
		public class Line
		{
			public string left;                             // set left of string
			public string right;                            // set right of string
			public bool isComplete = false;                 //  boolean value that check is the line added completely
			public RectOffset padding;                      // set padding if needed
			public LineStyle style;                         // set line style
			
            // setup the left right, iscomplete, padding and style for a line
