...
/*
* Creator: Yan Zhang
* the editor for conditions
* conditionProperty: the property od the condition
* descriptionProperty: the property of the description
* satisfiedProperty: the sattisfied property
* condition: a condition
* conditionButtonWidth: the width of the condition Button
* conditionPropDescriptionName: the name of the condition property
* conditionPropSatisfiedName: the name of the ondition properties
* conditionPropName: the name of the condition property
* blankDescription: the description show up if the slot is empty
*/ 
