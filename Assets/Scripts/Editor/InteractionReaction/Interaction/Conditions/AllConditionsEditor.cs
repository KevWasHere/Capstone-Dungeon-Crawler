...
* the editor of the All Conditions interface
* allConditionDescription: the all the conditions description
* conditionEditior: the condition Editor
* all Conditiona: the allCondtion variable
* newConditionDescription: default text of each new condition
*/
...
public class AllConditionsEditor : Editor
{
	...
	//set editor to null when disable
